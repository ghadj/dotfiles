...
# re-enable touchpad
alias enable_touchpad='sudo rmmod hid_multitouch'
alias disable_touchpad='sudo modprobe hid_multitouch'
# END of my aliases
eval $(thefuck --alias)

# >>> conda initialize >>>
# !! Contents within this block are managed by 'conda init' !!
__conda_setup="$('/home/george/anaconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
